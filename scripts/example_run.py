...
for evs in mv_iterator:
    ...
    # detect particles
    particles = ev_particlefinder(evs=window,
                                  min_area=100,
                                  h=h,
                                  w=w,
                                  )
...
all_particles = np.array(all_particles, dtype=dtype)  # reformat particle info to structured array
